...
class Sales(models.Model):
    ...
    ip = models.CharField(verbose_name='Cantidad de ip', max_length=300, blank=True, null=True)
    ...
    department = models.CharField(verbose_name='Departamento al que perteneceS', max_length=100)
    ...
    toPay = models.FloatField(verbose_name='Monto a pagar')
